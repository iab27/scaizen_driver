...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Carpatula 3</li>
        </ol>
    </nav>
    ...
    <div class="row">
        <div id="content" class="col-lg-12">
                        ...
                        <col style="width: 116px">
                          ...
                          <tr>
                            <td class="tg-k3k5" colspan="4">VOLUMEN DE CARGA</td>
                          </tr>
                          <tr>
                            <td class="tg-dvid"></td>
                            <td class="tg-9wq8" colspan="2" rowspan="4">15000</td>
                            <td class="tg-fckf"></td>
                          </tr>
                          <tr>
                            <td class="tg-dvid"></td>
                          ...
                          <tr>
                            <td class="tg-k3k5" colspan="4">CARGA SUMINISTRADA</td>
                          </tr>
                          <tr>
                            <td class="tg-dvid"></td>
                            <td class="tg-9wq8" colspan="2" rowspan="4">14898.42</td>
                            <td class="tg-fckf"></td>
                          </tr>
                          <tr>
                            <td class="tg-dvid"></td>
                          ...
                          <tr>
                            <td class="tg-zlqz" colspan="4">Simulation Mode</td>
                          </tr>
                          <tr>
