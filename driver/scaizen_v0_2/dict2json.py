...
#Esto lo agregué
API_ENDPOINT="https://127.0.0.1:5510/endpointdata"
def listToString(s):
    str1=''
    i=0
    for ele in s:
...
servidor_driver_ucl = {
    ...
    "mdp":{
        ...
        "data": {
            "flujoTR": str(flujoTR.registers[0]),
    ...
    "rtd":{
        ...
        "data": {
            "temperaturaTR": str(temperaturaTR.registers[0]),
    ...
    "baumanometro":{
        ...
        "data": {
            "presionTR": str(presionTR.registers[0]),
...
#Esto lo agregué
#r=requests.post(url=API_ENDPOINT,data=json_txt)
print(json_txt)
client.close()
