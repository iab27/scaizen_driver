...
class Process(object):
	...
	def readerr(self):
		...
		"""
		self.__lock.acquire()
		errdata = "".join(str(self.__collected_errdata))
	...
	def readboth(self):
		...
		"""
		self.__lock.acquire()
		outdata = "".join(str(self.__collected_outdata))
		del self.__collected_outdata[:]
		errdata = "".join(str(self.__collected_errdata))
		del self.__collected_errdata[:]
		self.__lock.release()
	...
	def _peek(self):
		self.__lock.acquire()
		output = "".join(str(self.__collected_outdata))
		error = "".join(str(self.__collected_errdata))
		self.__lock.release()
		return output,error
